  ...
  const go = async (e: React.FormEvent) => {
    ...
    try {
      const r = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({ access_key: WEB3_KEY, name: f.name, phone: f.phone, project: "Palm Hills Ras El Hekma 1400 Feddan", subject: "Lead — Palm Hills رأس الحكمة", email: "ahmed.a.rahim23@gmail.com" }),
      })
...
export default function Page() {
  ...
  const submitPopup = async (e: React.FormEvent) => {
    ...
    try {
      const r = await fetch("https://api.web3forms.com/submit", {
        method: "POST", headers: { "Content-Type": "application/json", Accept: "application/json" },
        body: JSON.stringify({ access_key: WEB3_KEY, name: popupForm.name, phone: popupForm.phone, project: "Palm Hills Ras El Hekma 1400 Feddan", subject: "Lead — Palm Hills رأس الحكمة (Popup)", email: "ahmed.a.rahim23@gmail.com" }),
      })
  ...
  return (
    <div dir="rtl">
        ...
        <div className="hero-grid" style={{ position: "relative", zIndex: 10, minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "space-between", maxWidth: 1200, margin: "0 auto", width: "100%", padding: "100px 40px 60px", gap: 48 }}>
          ...
          <div className="hero-text" style={{ flex: 1, maxWidth: 540 }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, marginBottom: 18, padding: "6px 14px", background: "rgba(139,26,26,.8)", borderRadius: 20 }}>
              ...
              <span style={{ fontSize: ".7rem", fontWeight: 700, color: "#fff" }}>🏖 Palm Hills Developments — رائد التطوير العقاري المصري</span>
            </div>
            ...
            <p style={{ fontSize: ".9rem", color: "rgba(255,255,255,.45)", lineHeight: 1.9, marginBottom: 28, maxWidth: 440 }}>
              فرصة استثمارية استثنائية — 4.8 كم شاطئ · تصميم OBMI · مارينا دولية · 3 فنادق فاخرة · عائد إيجاري مرتفع · تشطيب فاخر.
            </p>
            {/* Stats */}
      ...
      <div className="stat-bar" style={{ display: "flex", background: "#fff", borderBottom: "1px solid rgba(0,0,0,.04)" }}>
        {[{ i: "📐", v: "1,400 فدان", l: "مساحة استثمارية" }, { i: "🌊", v: "95%", l: "إطلالة بحر/لاجون" }, { i: "🏖", v: "4.8 كم", l: "شاطئ خاص" }, { i: "💰", v: "3 فنادق", l: "عائد إيجاري مرتفع" }].map((s, i) => (
        ...
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          <R>
            <div style={{ textAlign: "center", marginBottom: 40 }}>
              ...
              <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "2.2rem", fontWeight: 500, marginBottom: 12 }}>الوجهة الاستثمارية الأولى في رأس الحكمة</h2>
              <p style={{ fontSize: ".9rem", color: "#666", maxWidth: 650, margin: "0 auto", lineHeight: 1.9 }}>
                Palm Hills — أول مطور مصري يدخل رأس الحكمة بهذا الحجم. مشروع استثماري وسكني على 1,400 فدان بتصميم OBMI الحائز على جوائز دولية. يقع على كيلو 238 بواجهة 4.8 كم على البحر. عوائد إيجارية مرتفعة في موسم الصيف مع إمكانية الإقامة على مدار العام. 84% مساحات مائية وخضرة — 95% من الوحدات إطلالة بحر أو لاجون مباشر.
              </p>
            </div>
          </R>
      ...
      <section style={{ background: "#8B1A1A", padding: "40px" }}>
        <div className="mid-cta-grid" style={{ maxWidth: 900, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr auto", alignItems: "center", gap: 32 }}>
          <div>
            <h3 style={{ fontFamily: "'Playfair Display',serif", fontSize: "1.5rem", fontWeight: 500, color: "#fff", marginBottom: 6 }}>استثمر قبل اكتمال المشروع</h3>
